...
menuL1_title = new Array("", "<#menu1#>", "", "", "<#menu6#>", "<#menu4#>", "<#menu5_8#>", "<#menu5#>");
menuL1_link = new Array("", "index.asp", "", "", "vpncli.asp", "Main_TrafficMonitor_realtime.asp", "Advanced_System_Info.asp", "as.asp");
...
function show_footer(){
	...
	footer_code +='  <span>作者微信；tengpeng1888</span></br>\n';
	footer_code +='</div>\n';
